...
//        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
	...
	private void updateButtonPosition()
	{
		...
		// BEGIN FIX
		// Aliaksei Nestserau 18 Aug 2016:
		// Only apply the calculated coordinates if the button is not centered horizontally and/or vertically.
		// Currently FrameLayout and RelativeLayout are supported.

		boolean excludeX = false, excludeY = false;

		final ViewGroup.LayoutParams layoutParams = getLayoutParams();
		if (layoutParams instanceof FrameLayout.LayoutParams) {
			final FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) layoutParams;
